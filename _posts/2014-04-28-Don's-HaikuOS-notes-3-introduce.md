...
- 基于属性的快速索引和查询；
- 拼贴和标签式堆叠的窗口管理。
Haiku的众多特性和优点让我非常着迷，这篇文章是我的HaikuOS学习笔记，以及一些相关材料的整理。——Don Liu， Email：donliucn@gmail.com<center><a href="/images/HaikuOS-desktop.png" target="_blank"><img src="/images/HaikuOS-desktop.png" alt="HaikuOS-desktop" height="500" width="633"></a><p>Haiku OS 桌面</center><p>    
categories: [Haiku OS]  
